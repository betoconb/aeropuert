...
echo "<label id='boton'>REGRESAR A INICIO</label><br><br>";
...
echo "<table>
            ...
            <th>Llegada</th>
            <th>Precio</th>";
while($datos=mysqli_fetch_array($resultado_sql, MYSQLI_BOTH))//GENERA UNA TABLA DE LA INFORMACIÓN RECOLECTADA DE LA BASE DE DATOS CON LA CONSULTA MIENTRAS la consulta sea verdadera (mientras haya datos)
{
    echo "<tr>
            <td>".$datos[0]."</td>
            <td>".$datos[1]."</td>
